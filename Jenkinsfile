node {
    ...
    stage('Clone Repo') { // for display purposes
      ...
      git 'https://github.com/jatinkapoor009/cicd_repo'
      // Get the Maven tool.
    ...
    stage('Deploy Docker Image and login'){
      ...
      echo "Docker Image Tag Name: ${dockerImageTag}"
        ...
        sh "docker images"
        sh "docker login -u jatink9599 -p jatink9599@gmail.com" // put PWD
	...
	//sh "read imageid"
	   sh "docker tag b02d94624dac  jatink9599/myapplication:latest" //must change your name and tag no
        sh "docker push   jatink9599/myapplication:latest"
  }
}
